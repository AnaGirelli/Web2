...
export default {
    ...
    async getVendaProduto(req, res) {
        try {
            ...
            return res.status(500).json({ error: 'Erro ao buscar itens de venda', details: error.message });
        }
    },
    ...
    async deleteVendaProduto(req, res) {
        try {
            ...
            return res.status(500).json({ error: 'Erro ao deletar item de venda', details: error.message });
        }
    }
};