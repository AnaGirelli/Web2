...
export default {
    ...
    async create(req, res) {
        try {
            ...
            const vendaCompleta = await this.getVendaCompleta(novaVenda.id_venda);
    ...
    async list(req, res) {
        try {
            ...
            const vendasCompletas = await Promise.all(
                vendas.map(venda => this.getVendaCompleta(venda.id_venda))
            );
    ...
    async getById(req, res) {
        try {
            ...
            const vendaCompleta = await this.getVendaCompleta(id);
    ...
    async update(req, res) {
        try {
            ...
            const vendaAtualizada = await this.getVendaCompleta(id);
    ...
    async listVendedorPedidos(req, res) {
        try {
            ...
            const pedidos = await Promise.all(
                vendas.map(venda => this.getVendaCompleta(venda.id_venda, req.user.id))
            );
     ...
     */
    async getVendaCompleta(id_venda, id_vendedor = null) {
